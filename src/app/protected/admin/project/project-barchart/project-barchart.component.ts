...
@Component({
  selector: 'app-project-barchart',
  templateUrl: './project-barchart.component.html',
  styleUrls: ['./project-barchart.component.scss']
})
export class ProjectBarchartComponent implements OnInit {
  ...
  loadData() {
    this.isLoading = true;
    this._pjService.getProjectActualPrice(this.projectId).subscribe(price => {
